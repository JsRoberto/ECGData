...
A solução foi obter um parâmetro classificatório inicial e fixo, a fim de determinar o tipo, se de ruido ou de sinal, da menor quantidade de picos necessária para, a partir daí, utilizar o algoritmo do parâmetro de classificação adaptativo.  
