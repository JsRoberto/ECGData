...
classifying.peaks(dt.signal[[1]], peakValues[[1]], peakIndex[[1]], initial.THR[[1]])
classifying.peaks(dt.signal[[2]], peakValues[[2]], peakIndex[[2]], initial.THR[[2]])
classifying.peaks(dt.signal[[3]], peakValues[[3]], peakIndex[[3]], initial.THR[[3]])
classifying.peaks(dt.signal[[4]], peakValues[[4]], peakIndex[[4]], initial.THR[[4]])
classifying.peaks(dt.signal[[5]], peakValues[[5]], peakIndex[[5]], initial.THR[[5]])
classifying.peaks(dt.signal[[6]], peakValues[[6]], peakIndex[[6]], initial.THR[[6]])
classifying.peaks(dt.signal[[7]], peakValues[[7]], peakIndex[[7]], initial.THR[[7]])
classifying.peaks(dt.signal[[8]], peakValues[[8]], peakIndex[[8]], initial.THR[[8]])
#classifying.peaks(dt.signal[[9]], peakValues[[9]], peakIndex[[9]], initial.THR[[9]])
#classifying.peaks(dt.signal[[10]], peakValues[[10]], peakIndex[[10]], initial.THR[[10]])
...
Caso | Média e dp | Média e dp após norm.
-----|------------|----------------------
100  |`r Mean1[1]`|`r Mean1[2]`
