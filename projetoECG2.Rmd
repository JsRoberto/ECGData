...
Então, os dados assim obtidos estão representados na tabela a seguir.  

Caso|Média e dp|Média e dp após norm.|Nº QRS verdadeiro(Nv)|Nº QRS detectado(Nd)|Nº Falso Positivo|
----|----------|---------------------|---------------------|--------------------|-----------------|
100 |`r Mean1[1]` e `r Std1[1]`|`r Mean2[1]` e `r Std2[1]`| | |`r num.falsePos[1]]` 
